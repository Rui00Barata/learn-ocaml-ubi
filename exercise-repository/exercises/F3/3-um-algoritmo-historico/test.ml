(* 
  Euclide function: a, b contained in [0, +infinity[
...
let test_with_solution_both_negative = 
  Section([Text "Testes"],
          ...
          [%ty: int -> int -> int] 
          "euclides"
          ~sampler: (fun () -> (Random.int 999999) - 999999, (Random.int 999999) - 999999)
          ~gen:2
          []
    )
...
let () =
  ...
  [test_with_solution; test_with_solution_both_negative; test_with_solution_a_negative; test_with_solution_b_negative]
